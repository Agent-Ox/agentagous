    ...
    <>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-40 md:hidden" onClick={() => setMenuOpen(false)}>
          ...
          <div className="absolute top-0 right-0 h-full w-72 bg-zinc-950 border-l border-zinc-800 flex flex-col shadow-2xl"
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-800">
              ...
              <button onClick={() => setMenuOpen(false)}
                className="text-zinc-500 hover:text-white text-xl w-8 h-8 flex items-center justify-center rounded-lg hover:bg-zinc-800 transition-all">✕</button>
            </div>
