...
export const COMPANIES: Company[] = [
  ...
  { slug: 'spacex', name: 'SpaceX', layer: 'Labs & models',
    one_line: 'Acquired xAI in February and closed on the coding tool Cursor in August.',
  ...
  { slug: 'microsoft-scout', name: 'Microsoft Scout', layer: 'Work agents',
    ...
    url: 'https://copilot.microsoft.com' },
  { slug: 'perplexity', name: 'Perplexity', layer: 'Work agents', guide_slug: 'perplexity',
    one_line: 'Answers with citations, a browser agent in Comet, and a cloud agent in Computer.',
  ...
  { slug: 'devin', name: 'Devin', layer: 'Coding agents', guide_slug: 'devin',
    one_line: 'The original “AI software engineer”, cloud-hosted, cut from $500 to $20 a month.',
    url: 'https://devin.ai' },
  { slug: 'cognition', name: 'Cognition', layer: 'Coding agents', guide_slug: 'devin',
    one_line: 'The company behind Devin and Windsurf, valued at $47B on about $900M of revenue.',
    url: 'https://cognition.ai' },
  { slug: 'windsurf', name: 'Windsurf', layer: 'Coding agents', guide_slug: 'devin',
    one_line: 'The AI-native editor Cognition bought, renamed Devin Desktop in June 2026.',
    url: 'https://windsurf.com' },
  { slug: 'jules', name: 'Jules', layer: 'Coding agents',
    one_line: 'Google’s free cloud coding agent, running on Gemini.',
    url: 'https://jules.google' },
  { slug: 'cursor', name: 'Cursor', layer: 'Coding agents', guide_slug: 'cursor',
  ...
  { slug: 'meta-muse', name: 'Meta Muse', layer: 'Personal agents', guide_slug: 'meta-muse',
    ...
    url: 'https://ai.meta.com' },
  { slug: 'hermes-agent', name: 'Hermes Agent', layer: 'Personal agents', guide_slug: 'hermes',
    one_line: 'The open-source agent that writes its own skills and gets better the longer it runs.',
